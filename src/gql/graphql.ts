...
export type ProductsGetAllQuery = { products: Array<{ id: string, name: string, price: number, description: string, reviews: Array<{ rating?: number | null }>, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
